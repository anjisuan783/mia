...
{
    swr_ = swr_alloc_set_opts(nullptr, enc_->channel_layout, enc_->sample_fmt, enc_->sample_rate,
        decoder->channel_layout, decoder->sample_fmt, decoder->sample_rate, 0, nullptr);
    if (!swr_) {
