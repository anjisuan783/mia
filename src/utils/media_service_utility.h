...
#ifndef __MEDIA_SERVICE_UTILITY_H__
#define __MEDIA_SERVICE_UTILITY_H__
...
std::string srs_get_public_internet_address(bool ipv4_only = false);
...
// Get hostname
std::string srs_get_system_hostname(void);

}  //namespace ma

#endif //!__MEDIA_SERVICE_UTILITY_H__
