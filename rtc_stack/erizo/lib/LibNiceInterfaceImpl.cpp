...
NiceAgent* LibNiceInterfaceImpl::NiceAgentNewFull(GMainContext* context, int flag){
  return nice_agent_new_full(context, NICE_COMPATIBILITY_RFC5245, (NiceAgentOption)flag);
}
