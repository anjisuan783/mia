...
#include "api/video_codec_constants.h"
 ...
 public:
  ...
  struct ScalingSettings {
   ...
   public:
    ...
    // rather than a magic value. However, std::optional is not trivially copy
    ...
    // fix this when we switch to std::optional or std::optional.
