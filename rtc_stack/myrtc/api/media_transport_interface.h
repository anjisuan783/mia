...
#include "rtc_error.h"
#include "data_channel_transport_interface.h"
...
struct MediaTransportSettings final {
  ...
  std::optional<std::string> remote_transport_parameters;
...
class MediaTransportInterface : public DataChannelTransportInterface {
 public:
  ...
  virtual std::optional<std::string> GetTransportParametersOffer() const;
  ...
  // observers.
  virtual std::optional<TargetTransferRate> GetLatestTargetTransferRate();
