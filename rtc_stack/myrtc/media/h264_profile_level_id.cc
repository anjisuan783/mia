...
std::optional<Level> SupportedLevel(int max_frame_pixel_count, float max_fps) {
...
bool IsSameH264Profile(const CodecParameterMap& params1,
  ...
  const std::optional<webrtc::H264::ProfileLevelId> profile_level_id =
      webrtc::H264::ParseSdpProfileLevelId(params1);
  const std::optional<webrtc::H264::ProfileLevelId> other_profile_level_id =
