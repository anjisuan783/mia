...
RTC_EXPORT std::optional<ProfileLevelId> ParseSdpProfileLevelId(
...
RTC_EXPORT std::optional<Level> SupportedLevel(int max_frame_pixel_count,
                                                float max_fps);

// Returns canonical string representation as three hex bytes of the profile
// level id, or returns nothing for invalid profile level ids.
RTC_EXPORT std::optional<std::string> ProfileLevelIdToString(
