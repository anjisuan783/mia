...
#include "congestion_controller/bbr/bandwidth_sampler.h"
#include "congestion_controller/bbr/loss_rate_filter.h"
#include "congestion_controller/bbr/rtt_stats.h"
#include "congestion_controller/bbr/windowed_filter.h"
...
class BbrNetworkController : public NetworkControllerInterface {
 ...
 private:
  ...
  std::optional<TargetRateConstraints> constraints_;
  ...
  std::optional<Timestamp> aggregation_epoch_start_time_;
  ...
  std::optional<Timestamp> exit_probe_rtt_at_;
  ...
  std::optional<int64_t> end_recovery_at_;
