...
#include "pacing/bitrate_prober.h"
#include "pacing/interval_budget.h"
#include "pacing/round_robin_packet_queue.h"
#include "pacing/rtp_packet_pacer.h"
#include "rtp_rtcp/rtp_packet_sender.h"
...
class PacingController {
 public:
  ...
  std::optional<TimeDelta> TimeUntilNextProbe();
 ...
 private:
  ...
  DataSize PaddingToAdd(std::optional<DataSize> recommended_probe_size,
                        DataSize data_sent);
