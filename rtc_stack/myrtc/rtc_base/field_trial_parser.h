...
template <typename T>
std::optional<std::optional<T>> ParseOptionalParameter(std::string str) {
  if (str.empty())
...
template <>
std::optional<bool> ParseTypedParameter<bool>(std::string str);
template <>
std::optional<double> ParseTypedParameter<double>(std::string str);
template <>
std::optional<int> ParseTypedParameter<int>(std::string str);
template <>
std::optional<unsigned> ParseTypedParameter<unsigned>(std::string str);
template <>
std::optional<std::string> ParseTypedParameter<std::string>(std::string str);
...
ParseTypedParameter<std::optional<unsigned>>(std::string str);
template <>
std::optional<std::optional<double>>
ParseTypedParameter<std::optional<double>>(std::string str);
