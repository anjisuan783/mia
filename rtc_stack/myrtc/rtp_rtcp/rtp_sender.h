...
#include "rtp_rtcp/flexfec_sender.h"
...
#include "rtp_rtcp/rtp_packet_history.h"
...
class RTPSender {
 ...
 private:
  ...
  SendDelayMap::const_iterator max_delay_it_;
  ...
  uint64_t total_packet_send_delay_ms_;
  ...
  size_t rtp_overhead_bytes_per_packet_;
