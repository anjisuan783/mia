...
#include "cc/probe_bitrate_estimator.h"

#include <algorithm>
#include <memory>

#include "api/rtc_event_log.h"
#include "logging/rtc_event_probe_result_failure.h"
#include "logging/rtc_event_probe_result_success.h"
...
std::optional<DataRate> ProbeBitrateEstimator::last_estimate() const {
