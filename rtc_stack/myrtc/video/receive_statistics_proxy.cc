...
void ReceiveStatisticsProxy::UpdateHistograms(
  ...
  std::optional<int> delay_ms = delay_counter_.Avg(kMinRequiredSamples);
  if (delay_ms)
  ...
  std::optional<double> fps_fraction =
  ...
  std::optional<double> variance_fraction =
  ...
  std::optional<double> qp_fraction =
...
void ReceiveStatisticsProxy::QualitySample() {
  ...
  std::optional<int> qp = qp_sample_.Avg(1);
  ...
  std::optional<double> fps_variance_opt = fps_threshold_.CalculateVariance();
