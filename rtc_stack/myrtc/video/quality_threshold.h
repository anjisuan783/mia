...
class QualityThreshold {
 public:
  ...
  std::optional<bool> IsHigh() const;
  std::optional<double> CalculateVariance() const;
  std::optional<double> FractionHigh(int min_required_samples) const;
