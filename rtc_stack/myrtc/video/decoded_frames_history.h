...
class DecodedFramesHistory {
 public:
  ...
  std::optional<VideoLayerFrameId> GetLastDecodedFrameId();
  std::optional<uint32_t> GetLastDecodedFrameTimestamp();
 ...
 private:
  struct LayerHistory {
    ...
    std::optional<int64_t> last_picture_id;
  };
  ...
  std::optional<VideoLayerFrameId> last_decoded_frame_;
