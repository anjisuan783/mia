...

			{
				'b',
				{
					// b=AS:4000
					{
						...
						"bandwidth",
						// reg:
						Regular::regex("^(TIAS|AS|CT|RR|RS):(\\d*)"),
						// names:
						{ "type", "limit" },
						// types:
						{ 's', 'd' },
...

			{
				'a',
				{
					// a=rtpmap:110 opus/48000/2
					{
						...
						"rtp",
						// reg:
						Regular::regex("^rtpmap:(\\d*) ([\\w\\-\\.]*)(?:\\s*\\/(\\d*)(?:\\s*\\/(\\S*))?)?"),
						// names:
					...
					// a=rtcp-fb:98 trr-int 100
					{
						...
						"rtcpFbTrrInt",
						// reg:
						Regular::regex("^rtcp-fb:(\\*|\\d*) trr-int (\\d*)"),
						// names:
						{ "payload", "value" },
						// types:
						{ 's', 'd' },
					...
					// a=rtcp-fb:98 nack rpsi
					{
						...
						"rtcpFb",
						// reg:
						Regular::regex("^rtcp-fb:(\\*|\\d*) ([\\w\\-_]*)(?: ([\\w\\-_]*))?"),
						// names:
					...
					// a=extmap:3 urn:ietf:params:rtp-hdrext:encrypt urn:ietf:params:rtp-hdrext:smpte-tc 25@600/24
					{
						...
						"ext",
						// reg:
						Regular::regex("^extmap:(\\d+)(?:\\/(\\w+))?(?: (urn:ietf:params:rtp-hdrext:encrypt))? (\\S*)(?: (\\S*))?"),
						// names:
					...
					// a=extmap-allow-mixed
					{
						...
						"",
						// reg:
						Regular::regex("^(extmap-allow-mixed)"),
						// names:
						{ },
						// types:
						{ 's' },
					...
					// a=sendrecv
					{
						...
						"",
						// reg:
						Regular::regex("^(sendrecv|recvonly|sendonly|inactive)"),
						// names:
						{ },
						// types:
						{ 's' },
					...
					// a=candidate:3289912957 2 tcp 1845501695 193.84.77.194 60017 typ srflx raddr 192.168.34.75 rport 60017 tcptype passive generation 0 network-id 3 network-cost 10
					{
						...
						"candidates",
						// reg:
						Regular::regex("^candidate:(\\S*) (\\d*) (\\S*) (\\d*) (\\S*) (\\d*) typ (\\S*)(?: raddr (\\S*) rport (\\d*))?(?: tcptype (\\S*))?(?: generation (\\d*))?(?: network-id (\\d*))?(?: network-cost (\\d*))?"),
						// names:
					...
					// a=end-of-candidates
					{
						...
						"",
						// reg:
						Regular::regex("^(end-of-candidates)"),
						// names:
						{ },
						// types:
						{ 's' },
					...
					// a=remote-candidates:1 203.0.113.1 54400 2 203.0.113.1 54401
					{
						...
						"",
						// reg:
						Regular::regex("^remote-candidates:(.*)"),
						// names:
						{ },
						// types:
						{ 's' },
					...
					// a=ssrc-group:FEC-FR 3004364195 1080772241
					{
						...
						"ssrcGroups",
						// reg:
						Regular::regex("^ssrc-group:([\x21\x23\x24\x25\x26\x27\x2A\x2B\x2D\x2E\\w]*) (.*)"),
						// names:
						{ "semantics", "ssrcs" },
						// types:
						{ 's', 's' },
					...
					// a=msid-semantic: WMS Jvlam5X3SX1OP6pn20zWogvaKJz5Hjf9OnlV
					{
						...
						"",
						// reg:
						//Regular::regex("^msid-semantic:\\s?(\\w*) (\\S*)"),
						Regular::regex("^msid-semantic:\\s?(\\w*)\\s?(.*)"),
						// names:
						{ "semantic", "token" },
						// types:
					...
					// a=source-filter: incl IN IP4 239.5.2.31 10.1.15.5
					{
						...
						"",
						// reg:
						Regular::regex("^source-filter:[\\s\\t]+(excl|incl) (\\S*) (IP4|IP6|\\*) (\\S*) (.*)"),
						// names:
