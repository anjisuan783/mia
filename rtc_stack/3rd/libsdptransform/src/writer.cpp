...
namespace sdptransform
{
	...
	{
		static const Regular::regex FormatRegex("%[sdv%]");
		...
		for(
			auto it = Regular::sregex_iterator(format.begin(), format.end(), FormatRegex);
			it != Regular::sregex_iterator();
		  ++it
		 )
		{
			const Regular::smatch& match = *it;
